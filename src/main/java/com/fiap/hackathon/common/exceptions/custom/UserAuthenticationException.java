...
public class UserAuthenticationException extends CustomException {
    ...
    public UserAuthenticationException(ExceptionCodes code, String message) {
        super(code, message);
    }

    public UserAuthenticationException(ExceptionCodes code, String message, List<CustomError> customErrors) {
