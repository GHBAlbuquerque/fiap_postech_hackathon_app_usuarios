...
@Getter
public class RegisterPatientRequest extends RegisterUserRequest {

    public RegisterPatientRequest(@NotBlank String name, @NotNull LocalDate birthday, @NotBlank @Size(min = 11, message = "CPF deve ter 11 caracteres") String cpf, @NotBlank @Email(message = "E-mail deve ser válido") String email, @NotBlank @Size(min = 8, message = "A senha deve ter no mínimo 8 caracteres") String password, @NotBlank @Size(min = 11, message = "Telefone (com DDD) deve ter 11 caracteres") String contactNumber) {
